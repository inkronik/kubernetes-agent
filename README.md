...
`ghcr.io/inkronik/kubernetes-agent:1.1.3` and the hosted Collector at
...
```sh
kubectl apply -f \
  https://raw.githubusercontent.com/inkronik/kubernetes-agent/v1.1.3/deploy/kubernetes.yaml
...
docker run --rm ghcr.io/inkronik/kubernetes-agent:1.1.3 --version
```
